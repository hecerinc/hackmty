<div class="points index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('by_grades'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($point['Point']['month']); ?>&nbsp;</td>
		<td><?php echo h($point['Point']['semester']); ?>&nbsp;</td>
		<td><?php echo h($point['Point']['by_grades']); ?>&nbsp;</td>
		<td><?php echo h($point['Point']['grades']); ?>&nbsp;</td>
		<td><?php echo h($point['Point']['total']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $point['Point']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $point['Point']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
