<div class="requests index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('lowerdate'); ?></th>
			<th><?php echo $this->Paginator->sort('upperdate'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($request['Request']['comment']); ?>&nbsp;</td>
		<td><?php echo h($request['Request']['lowerdate']); ?>&nbsp;</td>
		<td><?php echo h($request['Request']['upperdate']); ?>&nbsp;</td>
		<td><?php echo h($request['Request']['accepted']); ?>&nbsp;</td>
