<div class="answers index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('upvote'); ?></th>
			<th><?php echo $this->Paginator->sort('downvote'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($answer['Answer']['upvote']); ?>&nbsp;</td>
		<td><?php echo h($answer['Answer']['downvote']); ?>&nbsp;</td>
